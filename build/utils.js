...
exports.entries = function () {
	...
	entryFiles.forEach((filePath) => {
		var filename = filePath.substring(filePath.lastIndexOf('\/pages') + 7, filePath.lastIndexOf('/index.js'))
...
exports.htmlPlugin = function () {
	...
	entryHtml.forEach((filePath) => {
		let filename = filePath.substring(filePath.lastIndexOf('\/pages') + 7, filePath.lastIndexOf('/index.html'))
		let conf = {
			// 模板来源
			template: filePath,
			// 文件名称
